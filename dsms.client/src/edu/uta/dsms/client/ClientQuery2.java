...
public class ClientQuery2
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            CQ_Join     join1 = new CQ_Join(2,
                                        "joinStreams",
                                        tbMotionDetection,
                                        tbDetectLight,
                                        "tbMotionDetectionTupleBased.RoomNumber == tbDetectLightTupleBased.RoomNumber");

            CQ_Select   select1  = new CQ_Select(1, "selectTuples",
            ...
            CQ_Project  root     = new CQ_Project(0, "projectFields",
                    "tbMotionDetectionTupleBased.RoomNumber, " +
                    "tbDetectLightTupleBased.RoomNumber, " +
                    "tbDetectLightTupleBased.LightSource, " +
                    "tbMotionDetectionTupleBased.SensorType");
