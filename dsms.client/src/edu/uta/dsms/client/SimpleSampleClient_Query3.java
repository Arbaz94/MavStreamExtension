 ...
 * @author Tim
 */
public class SimpleSampleClient_Query3
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            CQ_Stream tbDetectLight = new CQ_Stream(3, "tbDetectLightTupleBased", "tbDetectLightTupleBased");

            CQ_Project  root     = new CQ_Project(2, "project", "tbDetectLightTupleBased.LightStatus,tbDetectLightTupleBased.RoomNumber,tbDetectLightTupleBased.SensorID");

            CQ_Select   select1  = new CQ_Select(1, "select", "tbDetectLightTupleBased.LightStatus == 'ON' || tbDetectLightTupleBased.LightStatus == 'OFF'");

            CQ_GroupBy  groupBy1 = new CQ_GroupBy(0,
                                        "groupBy",
                                        "tbDetectLightTupleBased.LightStatus,tbDetectLightTupleBased.RoomNumber,tbDetectLightTupleBased.SensorID",
                                        "count",
                                        "tbDetectLightTupleBased.LightStatus",
                                        "count");
          ...
          //root.addInput(select1);
            select1.addInput(tbDetectLight);

            long startTime = 0;
            long endTime = 4000000000000L;
