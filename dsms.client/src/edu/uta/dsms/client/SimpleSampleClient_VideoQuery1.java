 ...
 * @author Mayur
 */
public class SimpleSampleClient_VideoQuery1
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            CQ_Project  root     = new CQ_Project(0, "project", "tbVideoDataParking.FrameId,tbVideoDataParking.PrevObjectId"); 

           // CQ_OrderBy orderby1 = new CQ_OrderBy(4,"order","tbVideoDataParking.ObjectId");



            root.addInput(tbVideoRel);
            //orderby1.addInput(tbVideoRel);
