 ...
 * @author Mayur
 */
public class SimpleSampleClient_VideoQuery2
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            CQ_Stream tbVideoRel = new CQ_Stream(3, "tbVideoDataParking", "tbVideoDataParking");

            CQ_Project  root     = new CQ_Project(0, "project", "tbVideoDataParking.FrameId,tbVideoDataParking.PrevObjectId");   //tbVideoRelational.FrameId,tbVideoRelational.ObjectId,

            CQ_Select   select1  = new CQ_Select(1, "select", "tbVideoDataParking.FrameId < '85' || tbVideoDataParking.ObjectId > '571' ");
