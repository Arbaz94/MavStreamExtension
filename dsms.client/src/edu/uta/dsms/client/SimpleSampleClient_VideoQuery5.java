 ...
 * @author Mayur
 */
public class SimpleSampleClient_VideoQuery5
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            CQ_Project  root     = new CQ_Project(0, "project", "tbVideoDataItlab.PrevObjectId,tbVideoDataItlab.tbSourceTS");
            ...
            CQ_ClientQuery cq = new CQ_ClientQuery(
    		   new CQ_ContinuousQuery(
    				   ...
    				   startTime,
    				   endTime,
    				   Long.parseLong("0"),Long.parseLong("15"),Long.parseLong("15"),
