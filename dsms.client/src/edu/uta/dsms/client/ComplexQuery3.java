...
public class ComplexQuery3
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            tuples1.add(new CQ_Tuple("1,0.1"));
            tuples2.add(new CQ_Tuple("1,1"));
            tuples3.add(new CQ_Tuple("1,15"));
            ...
            CQ_Select   select1 = new CQ_Select(2, "selectLightOnMotionOff", "tbMotionDetectionTupleBased.Motion == 'OFF'" +
                    " && tbDetectLightTupleBased.LightStatus == 'ON'");

            CQ_GroupBy  groupby1 = new CQ_GroupBy();
                groupby1.setId(1);
                groupby1.setName("groupbyFields");
                groupby1.setGroupByAttributes("tbMotionDetectionTupleBased.RoomNo, tbDetectLight.RoomNo");
                groupby1.setAggregateType("AVERAGE");
                groupby1.setInboundAggregateFieldName("tbDetectLight.LightIntensity");
                groupby1.setOutboundAggregateFieldName("AvgLightIntensity");

            CQ_Project  root     = new CQ_Project(0, "projectFields", "AvgLightIntensity");
