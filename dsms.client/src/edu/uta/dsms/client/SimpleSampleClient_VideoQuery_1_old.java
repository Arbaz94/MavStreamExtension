 ...
 * @author Mayur
 */
public class SimpleSampleClient_VideoQuery_1_old
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            CQ_Stream tbVideoRel = new CQ_Stream(2, "tbVideoRelational", "tbVideoRelational");

            CQ_Project  root     = new CQ_Project(0, "project", "tbVideoRelational.FrameId,tbVideoRelational.ObjectId,tbVideoRelational.PrevObjectId");

            CQ_Select   select1  = new CQ_Select(1, "select", "tbVideoRelational.FrameId <= 200");

            /*CQ_GroupBy  groupBy1 = new CQ_GroupBy(0,
                                        "groupBy",
                                        "tbVideoRelational.PrevObjectId",
                                        "count",*/
            long startTime = 0L;
            long endTime = 10000L;
       ...
       CQ_ClientQuery cq = new CQ_ClientQuery(
                    new CQ_ContinuousQuery(
                        ...
                        startTime,
                        endTime,
                        Long.parseLong("0"),Long.parseLong("2"),Long.parseLong("2"),
