...
public class ComplexQuery1
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            CQ_Stream tbMotionDetection = new CQ_Stream(5, "tbMotionDetectionTupleBased", "tbMD");
            CQ_Stream tbDetectLight = new CQ_Stream(6, "tbDetectLightTupleBased", "tbDL");

            CQ_Join     join1 = new CQ_Join(4,
                                        "joinStreams",
                                        tbMotionDetection,
                                        tbDetectLight,
                                        "tbMD.RoomNumber == tbDL.RoomNumber");

            CQ_Select   select1  = new CQ_Select(3, "selectTuples",
                    "tbDL.LightStatus == 'ON' && tbMD.Motion == 'ON'");

            CQ_Select   select2  = new CQ_Select(2, "selectOnLightSource",
                    "LightSource == 'IR_Ceiling'");

            CQ_Aggregate countID = new CQ_Aggregate(1, "countID", "COUNT", "tbMD.RoomNumber", "AllLightStatus");

//<<<<<<< ComplexQuery1.java
          //CQ_Aggregate countID = new CQ_Aggregate(1, "countID", "count", "tbDetectLightTupleBased.RoomNumber", "AllLightStatus");
//=======
//            CQ_Project  root     = new CQ_Project(0, "projectFields", "count(AllLightStatus)");
//>>>>>>> 1.2


            CQ_Project  root     = new CQ_Project(0, "projectFields", "tbMD.Motion,tbDL.LightStatus");
            ...
            CQ_ClientQuery cq = new CQ_ClientQuery(
                    new CQ_ContinuousQuery(
                        ...
                        SchedulingStrategy.PathCapacitySS.toString(),
                        "null",
                        10));
